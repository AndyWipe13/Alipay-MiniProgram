...
<view a:else class="ant-vtabs {{className ? className : ''}}" style="{{style}}">
  <view class="ant-vtabs-bar {{tabsBarClassName ? tabsBarClassName : ''}}" animation="{{myanimation}}">
  ...
  <view class="ant-vtabs-content" onTouchStart="touchStart" onTouchMove="touchMove" onTouchEnd="touchEnd">
    <slot value="{{items[mixin.value]}}" index="{{mixin.value}}">
