...
Component({
    ...
    didMount: function () {
        ...
        this.myanimation = my.createAnimation(
          {
            duration:500
          }
        )
    ...
    methods: {
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            this.setData({
                                rightFade: item.left + item.width / 2 > view.width-10,
                            });
                            return [2 /*return*/];
                    }
                });
        ...
        func(){
          this.myanimation.width(1).step()
          this.setData({ myanimation: this.myanimation.export() })
        },
        touchStart(e) {
        ...
        touchEnd(e) {
          ...
          if (this.moveX - this.startX > 60) {
            // 执行右滑操作
            this.myanimation.width(65).step()
            this.setData({ myanimation: this.myanimation.export() })
          } 
          if (this.startX - this.moveX > 60) {
            // 执行左滑操作
            this.myanimation.width(5).step()
            this.setData({ myanimation: this.myanimation.export() })
          }
          this.startX=0
          this.moveX=0
